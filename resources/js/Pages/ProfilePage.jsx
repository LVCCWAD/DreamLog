...
function ProfilePage({user, userBlogs, categories,}) {
  ...
  <div className="min-h-screen bg-stone-100 py-4">
    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <h2 className="text-3xl font-bold px-5 mt-10 mb-4">Created Categories</h2>
      <div className="flex flex-wrap gap-5 justify-start px-5">
          ...
          <div key={category.id} className="relative">
            ...
            {authUser.id === category.user_id && (
              <button
                ...
                className="absolute top-2 right-2 bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 shadow opacity-90"
              >
                X
              </button>
            )}
